	...
	if (results) {
		...
		for (let i = 0; i < x.length; i++) {
			...
			try {
				...
				var popup = L.popup()
					.setContent('<div role="listitem" class="property-card w-dyn-item"><div style="background-image:url(' + properties[i].statusImage + ')" class="banner"></div><a href=hammondrealty.ca/properties/' + properties[i].link + ' class="link-block-10 w-inline-block"><div data-w-id="86802cd9-7302-50a6-b1ed-7b26c6b6aaec" class="last-article-image-wrapper"><img style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" src=' + properties[i].image + ' alt="" sizes="(max-width: 767px) 162.015625px, (max-width: 991px) 21vw, (max-width: 1279px) 22vw, (max-width: 1439px) 17vw, 19vw" class="image-zoom"><div data-w-id="86802cd9-7302-50a6-b1ed-7b26c6b6aaee" style="display: none; width: 0px; height: 212.234px;" class="transition-bg-solid"></div></div><div class="div-block-10"><h2 class="heading-5">' + properties[i].name + '</h2><div class="div-block-11"><img src="https://assets-global.website-files.com/6176cec6a4e37b6a55ae0553/618c07883d62069be56731a5_place%20(3).png" loading="lazy" width="18" alt="" class="image-2"><div class="text-block-500">' + properties[i].location + '</div></div><div class="div-block-39"><div class="text-block-600">Price (P):</div><div class="text-block-400 currency">' + properties[i].price + '</div></div><div class="div-block-39"><div class="text-block-600">Title Acres:</div><div class="text-block-400 number">' + properties[i].acres + '</div></div><div class="div-block-39"><div class="text-block-600">Avg. AV/Qtr:</div><div class="text-block-400 currency">' + properties[i].perqtr + '</div></div><div class="div-block-39"><div class="text-block-600">Soil Final Rating:</div><div class="text-block-400">' + properties[i].soil + '</div></div><div class="div-block-39"><div class="text-block-600">$/acre:</div><div class="text-block-400 currency">' + properties[i].peracre + '</div></div></div><div class="w-embed"></div></a></div>')
